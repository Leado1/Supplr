          ...
          {resolvedParams.success && (
            <Alert className="mb-8 bg-green-50 border-green-200">
              ...
              <AlertDescription className="text-green-700">
                <strong>Message sent successfully!</strong> We've received your
                support request and will get back to you within 24 hours. You
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="urgent">
                          Urgent - System down or critical
                        </option>
                      </select>
                    </div>
            ...
            <Card className="bg-red-50 border-red-200">
              <CardContent className="py-6">
                ...
                <p className="text-red-700 mb-4">
                  If you're experiencing a critical system failure that's
                  affecting patient care, please mark your message as "Urgent"
                  above for immediate attention.
                </p>
