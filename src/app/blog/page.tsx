  ...
  const blogPosts = [
    {
      id: 1,
      title:
        "The Hidden Cost of Expired Medical Supplies: $47k Average Loss Per Practice",
      excerpt:
        "New industry research reveals shocking waste statistics from expired Botox, fillers, and medical supplies. Learn how practices are fighting back.",
    ...
    },
    {
      id: 2,
      title:
        "Temperature Monitoring: Protecting $50k+ of Cold-Storage Medical Products",
      excerpt:
        "How temperature excursions destroy expensive Botox and vaccines, and the technology preventing these costly mistakes.",
    ...
    },
    {
      ...
      excerpt:
        "Navigate FDA regulations for medical devices and injectables with automated lot tracking and recall reporting.",
      category: "Compliance",
      readTime: "4 min read",
      date: "Jan 3, 2026",
    ...
    },
    {
      ...
      excerpt:
        "From expired Juvederm to emergency supply runs, recognize the warning signs that you're losing money on inventory.",
    ...
    },
    {
      id: 5,
      title:
        "ROI Calculator: How Much Money Is Your Practice Losing to Expired Supplies?",
      excerpt:
        "Use our free calculator to estimate your annual losses from expired medical supplies and see potential savings.",
      category: "Tools",
      readTime: "3 min read",
      date: "Dec 28, 2025",
      author: "Supplr Team",
    ...
    },
    {
      id: 6,
      title:
        "Multi-Location Medical Practices: Centralizing Inventory Without Chaos",
      excerpt:
        "Best practices for managing inventory across multiple clinic locations, from bulk purchasing to transfer tracking.",
        ...
        <section className="py-20 lg:py-24">
          <div className="container mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-xl text-muted-foreground leading-relaxed">
              Expert guidance, industry insights, and best practices for medical
          ...
          <div className="container mx-auto max-w-4xl px-4 text-center">
            <div className="bg-background rounded-2xl p-8 shadow-xl border-2 border-primary/20">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Get weekly insights on medical inventory management, compliance
                updates, and cost-saving strategies delivered to your inbox.
              </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Strategies to reduce waste and maximize ROI
                </p>
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  FDA regulations and HIPAA requirements
                </p>
